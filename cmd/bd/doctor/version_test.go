...
func TestCompareVersions(t *testing.T) {
	tests := []struct {
		...
		{"calver equal", "2026.218.0", "2026.218.0", 0},
		{"calver newer day", "2026.219.0", "2026.218.0", 1},
		{"calver older day", "2026.217.3", "2026.218.0", -1},
		{"calver newer N", "2026.218.1", "2026.218.0", 1},
		{"calver newer month", "2026.301.0", "2026.228.5", 1},
		{"calver vs semver upgrade", "2026.218.0", "0.62.17", 1},
		{"semver vs calver downgrade", "0.62.17", "2026.218.0", -1},
	}
...
func TestIsValidSemver(t *testing.T) {
	tests := []struct {
		...
		{"valid calver", "2026.218.0", true},
		{"valid calver multi-digit N", "2026.218.15", true},
		{"empty string", "", false},
...
func TestParseVersionParts(t *testing.T) {
	tests := []struct {
		...
		{"calver 3 parts", "2026.218.3", []int{2026, 218, 3}},
