...
- Update helm chart values to reference the CalVer tag (e.g., `2026.218.0`)
- Deploy via `helm upgrade`
- beads tags use CalVer (e.g., `2026.218.0`) — binary version now matches deployed image tags
