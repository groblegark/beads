...
type KeyMap struct {
	...
	Expand     key.Binding // Expand/collapse selected epic
...
func (k KeyMap) ShortHelp() []key.Binding {
	return []key.Binding{k.Up, k.Down, k.ToggleView, k.Expand, k.Refresh, k.Help, k.Quit}
}
...
func (k KeyMap) FullHelp() [][]key.Binding {
	return [][]key.Binding{
		...
		{k.ToggleView, k.Expand, k.Refresh},
		{k.Help, k.Quit},
	}
}
