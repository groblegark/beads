...
// NOTE: TestValidateIDPrefixAllowed was removed because the function ValidateIDPrefixAllowed
// was not implemented in this package. The test was written for planned functionality
// that was never added or was removed in an upstream rebase.
