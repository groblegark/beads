...
bd import -i .beads/issues.jsonl  # Now uses resurrect mode by default
```
...
Dolt handles synchronization automatically. For manual export/import:
...
# End of session
# Dolt handles sync automatically - no manual step needed
```
